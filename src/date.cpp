...
private:
  void format(uint64_t timestamp) {
    ...
    snprintf(formatted_, sizeof(formatted_),
             "%04d%02d%02d-%02d:%02d:%02d.%06lluZ ", local_tm.tm_year + 1900,
             local_tm.tm_mon, local_tm.tm_mday, local_tm.tm_hour,
             local_tm.tm_min, local_tm.tm_sec, timestamp % 1000000UL);
#else
    snprintf(formatted_, sizeof(formatted_),
             "%04d%02d%02d-%02d:%02d:%02d.%03lluZ ", local_tm.tm_year + 1900,
             local_tm.tm_mon, local_tm.tm_mday, local_tm.tm_hour,
             local_tm.tm_min, local_tm.tm_sec, (timestamp % 1000000UL) / 1000);
#endif
